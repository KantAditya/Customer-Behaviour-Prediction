...
class AprioriCalculation
{
    ...
    String configFile="C:\\Users\\Abhay\\eclipse-workspace\\firstproject\\src\\config.txt"; //configuration file
    String transaFile="C:\\Users\\Abhay\\eclipse-workspace\\firstproject\\src\\out.txt"; //transaction file
    String outputFile="C:\\Users\\Abhay\\eclipse-workspace\\firstproject\\src\\apriori-output.txt"
    		+ "";//output file
     ...
     * Return       : None
     *************************************************************************/
    public  void calculateFrequentItemsets(int n)
    {
        ...
        try
        {
                ...
                for(int i=0; i<candidates.size(); i++)
                {
                    ...
                    if((count[i]/(double)numTransactions)>=minSup)
                    {
                        ...
                        //System.out.println(new String(candidates.get(i)));
                    }
                }
        ...
        for (int i1 = 0; i1 < a.size();i1++) {
                string.append(a.get(i1).toString());
        	}
