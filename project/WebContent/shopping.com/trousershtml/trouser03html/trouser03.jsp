...
<body>
	...
	<div class="container">
		<div class="row my-4">
			...
			<div class="col-lg-4">
				<h1>WROGN Men Black Slim Fit Mid-Rise Jeans</h1>
				<h3>Original Price: Rs. 2299(20% OFF)</h3>
				<h2>Rs. 1839</h2>
				<p>A pair of black 5-pocket mid-rise jeans, has zip fly with a
					button closure, a waistband with belt loops; 98% cotton, 2%
					elastane; Machine-wash.</p>
