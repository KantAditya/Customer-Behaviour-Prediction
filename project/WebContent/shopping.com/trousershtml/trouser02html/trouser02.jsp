...
<title>American Crew | Shopping.com</title>
...
<body>
	...
	<div class="container">
		<div class="row my-4">
			...
			<div class="col-lg-4">
				<h1>American Crew Men Black Straight Fit Mid-Rise Clean Look
					Jeans</h1>
				<h3>Original Price: Rs. 2999(75% OFF)</h3>
				<h2>Rs. 749</h2>
				<p>Black dark wash 5-pocket mid-rise jeans, clean look with
					light fade, has a button and zip closure, waistband with belt
					loops; Cotton; Machine-wash.</p>
