...
<body>
	...
	<div class="container">
		<div class="row my-4">
			...
			<div class="col-lg-4">
				<h1>Roadster Unisex Aviator sunglasses</h1>
				<h3>Original Price: Rs. 899(40% OFF)</h3>
				<h2>Rs. 539</h2>
				<p>Lens colour: black; Lens feature: UV protected lens; Frame
					material: metal; Frame style: full rim; Best suited for: oval face
					shape; Comes in a signature Roadster hard case; Warranty: No
					warranty</p>
		...
		<div class="row">
			<%
				try {
					...
					String sql = "select s.* from product p,watch s where p.pid='6' && p.id=s.id";
