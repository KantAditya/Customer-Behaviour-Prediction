...
<body>
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item"><a class="nav-link"
					href="../sunglasses.jsp">Back to Menu</a></li>
	...
	<div class="container">
		<div class="row my-4">
			...
			<div class="col-lg-4">
				<h1>MTV Unisex Mirrored Aviator Sunglasses 123-C20</h1>
				<h3>Original Price: Rs. 1199(55% OFF)</h3>
				<h2>Rs. 539</h2>
				<p>Lens colour: Mirrored; Lens feature: UV Protected Lens; Frame
					material: Metal; Frame style: Full Rim; Best suited for: Oval face
					shape; Comes in a signature MTV case; Warranty: 6 months; Warranty
					provided by brand/manufacturer</p>
		...
		<div class="row">
			...
			<div class="col-md-4 mb-4">
				<div class="card h-100">
					<div class="card-body">
						<h4 class="card-title">Floyd</h4>
						<p class="card-text">Unisex Aviator Sunglasses W123</p>
					</div>
					<div class="card-footer">
						<a href="../sunglass03html/sunglass03.jsp" class="btn btn-success">More
							Info</a>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<%
				try {
					...
					String sql = "select s.* from product p,watch s where p.pid='4' && p.id=s.id";
					...
					while (rs.next()) {
						...
						FileOutputStream out1 = new FileOutputStream(
								"C:\\Users\\Abhay\\eclipse-workspace\\firstproject\\WebContent\\images\\" + filename);
