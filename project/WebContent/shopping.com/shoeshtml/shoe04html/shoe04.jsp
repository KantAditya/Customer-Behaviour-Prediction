...
<body>
	...
	<div class="container">
		<div class="row my-4">
			...
			<div class="col-lg-4">
				<h1>Puma Men Navy Reef Fashion Running Shoes</h1>
				<h3>Original Price: Rs. 3299(40% OFF)</h3>
				<h2>Rs. 1979</h2>
				<p>A pair of navy blue running sports shoes, has regular
					styling, lace-up detail, Mesh upper, Cushioned footbed, Textured
					and patterned outsole, Warranty: 3 months, Warranty provided by
					Brand Owner / Manufacturer; Mesh; Wipe with a clean, dry cloth to
					remove dust.</p>
