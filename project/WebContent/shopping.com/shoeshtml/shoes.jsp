...
<title>Shoes | Shopping.Com</title>
...
<body>
	...
	<div class="container">
		<header
			...
			<div class="container">
				<h1 class="text-uppercase mb-0">Welcome to the SHOES section!</h1>
		...
		<div class="row text-center">
			<div class="col-lg-3 col-md-6 mb-4">
				<div class="card">
					...
					<div class="card-footer">
						<a href="shoe01html/shoe01.jsp" class="btn btn-success">Find
							Out More!</a>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 mb-4">
				<div class="card">
					...
					<div class="card-footer">
						<a href="shoe02html/shoe02.jsp" class="btn btn-success">Find
							Out More!</a>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 mb-4">
				<div class="card">
					...
					<div class="card-footer">
						<a href="shoe03html/shoe03.jsp" class="btn btn-success">Find
							Out More!</a>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 mb-4">
				<div class="card">
					...
					<div class="card-footer">
						<a href="shoe04html/shoe04.jsp" class="btn btn-success">Find
							Out More!</a>
					</div>
				</div>
			</div>
