...
<title>Shirts | Shopping.Com</title>
...
<body>
	...
	<div class="container">
		<header
			...
			<div class="container">
				<h1 class="text-uppercase mb-0">Welcome to the SHIRTS section!</h1>
		...
		<div class="row text-center">
			<div class="col-lg-3 col-md-6 mb-4">
				<div class="card">
					...
					<div class="card-footer">
						<a href="shirt01html/shirt01.jsp" class="btn btn-success">Find
							Out More!</a>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 mb-4">
				<div class="card">
					...
					<div class="card-footer">
						<a href="shirt02html/shirt02.jsp" class="btn btn-success">Find
							Out More!</a>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 mb-4">
				<div class="card">
					...
					<div class="card-footer">
						<a href="shirt03html/shirt03.jsp" class="btn btn-success">Find
							Out More!</a>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 mb-4">
				<div class="card">
					...
					<div class="card-footer">
						<a href="shirt04html/shirt04.jsp" class="btn btn-success">Find
							Out More!</a>
					</div>
				</div>
			</div>
