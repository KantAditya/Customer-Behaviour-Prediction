...
<body>
	...
	<div class="container">
		<div class="row my-4">
			...
			<div class="col-lg-4">
				<h1>ether BLUE ANTI MICROBIAL FILAFIL Slim Fit Shirt</h1>
				<h3>Original Price: Rs. 1099(40% OFF)</h3>
				<h2>Rs. 659</h2>
				<p>Blue casual shirt, has a spread collar, full button placket,
					long sleeves, a patch pocket, a curved hem; 100% cotton;
					Machine-wash cold.</p>
