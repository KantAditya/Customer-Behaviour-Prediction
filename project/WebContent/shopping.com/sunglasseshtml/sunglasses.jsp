...
<title>Sunglasses | Shopping.Com</title>
...
<body>
	...
	<div class="container">
		<header
			...
			<div class="container">
				<h1 class="text-uppercase mb-0">Welcome to the SUNGLASSES
					section!</h1>
				<h2 class="font-weight-light mb-0">A wide collection of premium
					brands that suits your style.</h2>
			</div>
		</header>
		<div class="row text-center">
			<div class="col-lg-3 col-md-6 mb-4">
				<div class="card">
					...
					<div class="card-footer">
						<a href="sunglass01html/sunglass01.jsp" class="btn btn-success">Find
							Out More!</a>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 mb-4">
				<div class="card">
					...
					<div class="card-footer">
						<a href="sunglass02html/sunglass02.jsp" class="btn btn-success">Find
							Out More!</a>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 mb-4">
				<div class="card">
					...
					<div class="card-footer">
						<a href="sunglass03html/sunglass03.jsp" class="btn btn-success">Find
							Out More!</a>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 mb-4">
				<div class="card">
					...
					<div class="card-footer">
						<a href="sunglass04html/sunglass04.jsp" class="btn btn-success">Find
							Out More!</a>
					</div>
				</div>
			</div>
