...
<title>Login | Shopping.Com</title>
		...
		<div class="container">
			<div class="panel panel-primary col-xs-6 col-xs-offset-3">
				...
				<div class="container panel-body">
					...
					<form method="GET" action="/firstproject/Loginservlet">
				...
				<div class="container panel-footer">
					<p>
						Don't have an account? Thyen go to <a href="signup.jsp"><button
								class="btn btn-default">Signup</button></a>
					</p>
				</div>
				</br>
			</div>
