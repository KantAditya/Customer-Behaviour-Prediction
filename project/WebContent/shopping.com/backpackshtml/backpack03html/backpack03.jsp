...
<title>Zwart | Shopping.com</title>
...
<body>
	...
	<div class="container">
		<div class="row my-4">
			...
			<div class="col-lg-4">
				<h1>Zwart Unisex Grey & Blue XCITE Colourblocked Backpack</h1>
				<h3>Original Price: Rs. 3800(Rs. 2,660 OFF)</h3>
				<h2>Rs. 1140</h2>
				<p>Grey, blue and black colourblocked backpack Padded haul
					loop,? compression straps, hip strap 2 main compartments with zip
					closure, has a laptop sleeve 1 external zip pocket, 2 stash pockets
					Padded back Padded shoulder strap Warranty: 1 year Warranty
