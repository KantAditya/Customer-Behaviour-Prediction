...
<body>
	...
	<div class="container">
		<div class="row my-4">
			...
			<div class="col-lg-4">
				<h1>Nike Unisex Red & Black Colourblocked NK ALPHA REV Backpack</h1>
				<h3>Original Price: Rs. 3295(40% OFF)</h3>
				<h2>Rs. 1977</h2>
				<p>Red and black colourblocked backpack Padded haul loop 2 main
					compartments with zip closure Padded back Zip Pocket and 2 stash
					pockets Padded shoulder strap: Padded Volume: up to 23 litres
					Warranty: 6 months Warranty provided by Brand Owner / Manufacturer.</p>
		...
		<div class="row">
			...
			<div class="col-md-4 mb-4">
				<div class="card h-100">
					<div class="card-body">
						<h4 class="card-title">U.S. Polo Assn.</h4>
						<p class="card-text">Unisex Navy Laptop Backpack</p>
					</div>
					<div class="card-footer">
						<a href="../backpack02html/backpack02.jsp" class="btn btn-success">More
							Info</a>
					</div>
				</div>
			</div>
