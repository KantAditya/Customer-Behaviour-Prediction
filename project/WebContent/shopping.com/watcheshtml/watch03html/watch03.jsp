...
<title>Tommy Hilfiger | Shopping.com</title>
...
<body>
	...
	<div class="container">
		<div class="row my-4">
			...
			<div class="col-lg-4">
				<h1>Tommy Hilfiger Men Black Dial Watch TH1791178J</h1>
				<h3>Original Price: Rs. 8750(50% OFF)</h3>
				<h2>Rs. 4375</h2>
				<p>Dial width: 45 mm; Strap width: 20 mm; Case style: Analogue
					watch with a circular case and a stainless steel back; Dial style:
					Black dial, has glow-in-the-dark inlay on the hour hand; Features:
					A screw to reset thenbsp;time andnbsp;a tachymeter; Strap style:
					Silver-toned bracelet-stylenbsp;strap, secured with a butterfly
					clasp; Water-resistant up to 30 m; Comes in a signature Tommy
					Hilfiger hard case; Warranty: 2 years from the date of purchase.</p>
		...
		<div class="row">
			...
			<div class="col-md-4 mb-4">
				<div class="card h-100">
					<div class="card-body">
						<h4 class="card-title">Fossil</h4>
						<p class="card-text">Men Navy Chronograph Watch FS5210</p>
					</div>
					<div class="card-footer">
						<a href="../watch02html/watch02.jsp" class="btn btn-success">More
							Info</a>
					</div>
				</div>
			</div>
