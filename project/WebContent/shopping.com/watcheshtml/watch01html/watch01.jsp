...
<body>
	...
	<div class="container">
		<div class="row my-4">
			...
			<div class="col-lg-4">
				<h1>Roadster Men Black Analogue Watch PN-LB-80300</h1>
				<h3>Original Price: Rs. 3299(40% OFF)</h3>
				<h2>Rs. Rs. 1979</h2>
				<p>Dial width: 40 mm; Strap Width: 20 mm; Display: Analogue;
					Movement: Mechanical; Power source: Battery; Dial style: Patterned
					round stainless steel dial; Features: Reset Time; Strap style:
					Gunmetal Toned bracelet style, stainless steel strap with a
					foldover closure; Water Resistant.</p>
